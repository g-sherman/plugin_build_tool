...
* *pbt* can now create two plugin skeletons as project starts for you:
  ...
  #. minimal: a minimalist plugin from Martin Dobias (wonder-sk)consisting of two files. For information, see [https://github.com/wonder-sk/qgis-minimal-plugin](https://github.com/wonder-sk/qgis-minimal-plugin)
  #. create: a dialog-based plugin similar to that generated by Plugin Builder
